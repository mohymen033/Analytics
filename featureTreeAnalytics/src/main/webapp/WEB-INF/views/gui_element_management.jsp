...
<br>
<fieldset>
	<legend>::DashBoard::Manage GUI Element</legend>
	<table border="1">
<thead>
	<th>Id</th>
...
<tbody>
	...
	<tr>	
		...
		<td><a href="/featureTreeAnalytics/editGuielement?id=${guielement.id}">Modify</a></td>
	</tr>	
	</c:forEach>
	</c:if>
</tbody>
...
<br><a href="/featureTreeAnalytics/addGuielement"> Add GUI Element </a>
