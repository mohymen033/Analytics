...
<title>Statistics of Feature Tree</title>
...
<script type="text/javascript">
	function doAjaxPostG1() {  
	   ...
	   $.ajax({  
	     type: "GET",  
	     url: "/featureTreeAnalytics/getAjaxResponse",  
...
<body id="pgbody" onLoad="initDefaultGraphData()">
	<div align="center">
		<font size="4" face="Verdana"color"#800080">
			Visual Analytics of Feature Tree |<a href="/featureTreeAnalytics"> Home</a>
		</font>
	</div>
	<div id="container" style="height: 550px; width: 1300px">
		<div id="menu" style="background-color: #F3F3F3; height: 550px; width: 240px; float: left;">
			...
			<div id="menu1_1" style="height: 275px; width: 240px; float: left; text-align: left; border: gray 1px solid;">
			...
			<div id="menu1_2" style="height: 275px; width: 240px; float: left; text-align: left; border: gray 1px solid;">
				<b><label for="featureId2">Feature Tree:</label></b>
				<ul>
					<li>
		...
		<div id="content" style="height: 550px; width: 1060px; float: left;">
			<div id="content1_1" style="height: 274px; width: 1060px; float: left;">
				<div id="content1_1_1" style="height: 274px; width: 528px; float: left; text-align: left; border: red 1px solid;">
					...
					<input type="text" id="fromG1" name="fromG1" /> 
					<label for="toG1"><font size="1" face="times new roman">To</font></label> 
					<input type="text" id="toG1" name="toG1" />

					<div id="chart_div_g1" style="width: 500px; height: 130px;"></div>
				</div>

				<div id="content1_1_2"
					style="height: 274px; width: 528px; float: left; text-align: left; border: green 1px solid;">
					...
					<input type="text" id="fromG2" name="fromG2" /> 
					<label for="toG2"><font size="1" face="times new roman">To</font></label> 
					<input type="text" id="toG2" name="toG2" />
			...
			<div id="content1_2" style="height: 274px; width: 1060px; float: left;">
				<div id="content1_2_1" style="height: 274px; width: 528px; float: left; text-align: left; border: green 1px solid;">
					...
					<input type="text" id="fromG3" name="fromG3" /> 
					<label for="toG3"><font size="1" face="times new roman">To</font></label> 
					<input type="text" id="toG3" name="toG3" />

					<div id="chart_div_g3" style="width: 500px; height: 130px;"></div>
				</div>

				<div id="content1_2_2" style="height: 274px; width: 528px; float: left; text-align: left; border: red 1px solid;">
					...
					<input type="text" id="fromG4" name="fromG4" /> 
					<label for="toG4"><font size="1" face="times new roman">To</font></label> 
					<input type="text" id="toG4" name="toG4" />
