...
public class GuielementController extends HttpServlet {
	...
	public String addGuielementvisit(Locale locale, Model model,HttpServletRequest request) {
		...
		DbController sql = new DbController();
		logger.info("Welcome GUI Element Visit save! the client locale is "+ locale.toString());
		...
		logger.info("Feature Analytics: "+ guielementidname);
		...
		{	
			...
			String query=" INSERT INTO `feature_tree_analytics`.`gui_element_visit` (`visitorid`, `visitoriformation`, `visitelementname`, `elementvisitcount`, `elementlastvisittime`, `elementvisitsessionid`, `visitoraddress`, `elementfirstvisittime`, `ipaddress`) VALUES (NULL, 'Anonymous', '"+guielementidname+"', '1', '"+formattedDate+"', '"+sessionId+"', '"+visitorAddress+"', '"+formattedDate+"','"+ipaddress+"') ";
			//String query="INSERT INTO `feature_tree_analytics`.`gui_element_visit` (`visitorid`, `visitoriformation`, `visitelementname`, `elementvisitcount`, `elementfirstvisittime`, `elementvisitsessionid`,`visitoraddress`) VALUES (NULL, 'Anonymous', '"+guielementidname+"', '1', '"+formattedDate+"', '"+sessionId+"','"+visitorAddress+"')";
