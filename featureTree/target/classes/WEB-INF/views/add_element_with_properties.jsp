...
<body>
<h1>Configure Graphical User Interface Element Properties!</h1>
<h2>Add New Graphical User Interface Element with Properties</h2>
<br>

<c:url var="saveGuielementUrl" value="/saveGuielement" />
<form id="frmAddGuielements" action="${saveGuielementUrl}" method="POST">
<table>
	<tr>
