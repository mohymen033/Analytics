...
<br>
<fieldset>
	<legend>::DashBoard::Feature Management of PM Site</legend>
<table border="1">
<thead>
	<th>Id</th>
	<th>Name</th>
...
<tbody>
	...
	<tr>	
		...
		<td><a href="/featureTree/editFeaturePM?id=${feature.id}">Modify</a></td>
	</tr>	
	</c:forEach>
	</c:if>
</tbody>
...
<br><a href="/featureTree/addFeaturePM"> Add Feature </a>
